...
unsigned int nTargetSpacing = 2 * 60; //Block  spacing 
unsigned int nStakeMinAge = 8 * 60 ; //Minimum stake age 
unsigned int nStakeMaxAge = 24 * 60 * 60 * 90 * 4; //Maximum stake age 90days
...
const string strMessageMagic = "babacoin Signed Message:\n";
...
const int YEARLY_BLOCKCOUNT = 125000; //block will execute with in 6months
...
static const int64_t nTargetTimespan = 24 * 60 *60 *30 *12;
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "babacoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "jan 2018";
        CTransaction txNew;
        txNew.nTime = 1514275542;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0xc72627114ae4998c632a06940ccefad7d40abdd97548e8161efead2e91de49fd"));
